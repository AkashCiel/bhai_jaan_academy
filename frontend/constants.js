...
export const ABOUT_TEXT = `Thanks to the internet, we can learn almost anything. But, where do you start? Therefore, I created <strong>Bhai Jaan Academy</strong>. You give your <strong>email address</strong> and the <strong>topic</strong> you wish to learn. You will receive a comprehensive learning plan and regular content to read. If you find this useful, please purchase your first topic. With this purchase, you get access to:<br><br>
